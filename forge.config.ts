...
import {
  removeMacCodeSignatures,
  shouldRemoveMacCodeSignatures,
} from "./tools/lib/mac-signature-sanitizer.mjs";
...
const linuxDesktopTemplate = resolve(
  "packaging/linux/netft-viewer.desktop.ejs",
);
const legalResources = [resolve("LICENSE"), resolve("LICENSES")];

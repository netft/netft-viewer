...
test("release metadata agrees on version 0.1.0 and release date", async () => {
  ...
  assert.match(cmake, /project\(netft_viewer VERSION 0\.1\.0\b/);
  assert.match(pixi, /^version = "0\.1\.0"$/m);
  assert.match(changelog, /^## \[0\.1\.0\] - 2026-07-27$/m);
});
